...
namespace ProcessEvent
{
	...
	void HookedProcessEvent(UObject* Class, UFunction* Function, void* Params)
	{
		...
		{
			static UObject* clientSetCameraMode = Engine::GObjects->FindObject("Function Engine.PlayerController.ClientSetCameraMode");
		...
		{
			static UObject* IsInputActionEnabled = Engine::GObjects->FindObject("Function PortalWars.PortalWarsUserWidget.IsInputActionEnabled");
		...
		{
			static UObject* BroadcastDeath = Engine::GObjects->FindObject("Function PortalWars.PortalWarsPlayerState.BroadcastDeath_Multicast");
		...
		{
			static UObject* ClientUpdateChat = Engine::GObjects->FindObject("Function PortalWars.PortalWarsPlayerController.ClientUpdateChat");
		...
		if (!Events::Empty())
		{
			static const std::unordered_map<UObject*, Events::Type> gameEventByFn = []
			{
				...
				{
					if (UObject* obj = Engine::GObjects->FindObject(name)) map[obj] = event;
				}
				return map;
			}();
