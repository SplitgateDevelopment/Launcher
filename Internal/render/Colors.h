...
namespace Render
{
	...
	namespace Palette
	{
		...
		inline constexpr Color Background{0.92f, 0.91f, 0.88f, 1.00f}; ///< window background
		...
		inline constexpr Color Success{0.00f, 0.80f, 0.28f, 1.00f}; ///< enabled/on state (e.g. checked toggles)
		inline constexpr Color Muted{0.70f, 0.70f, 0.70f, 1.00f};	///< muted gray (e.g. slider knob)
	} // namespace Palette
} // namespace Render
